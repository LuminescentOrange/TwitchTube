...
import com.jupiter.entity.db.Item;
import com.jupiter.entity.db.ItemType;
...
import com.jupiter.entity.response.Game;
 ...
 * @date 2022/2/25 5:01
 */
// package service 是业务逻辑
@Service//annotation，包含了component,是业务逻辑 看见了之后创建create,与controller， repository 分别对应XXXservice业务逻辑, Controller,
// database更细化
public class GameService {
    private static final String TOKEN = "Bearer jmcgsf08ck5060vifvaxxj0a6j6wd4";
